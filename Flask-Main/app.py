...
model=pickle.load(open("recommend.pkl",'rb'))  #loading the model

#loading the updated dataset
us_canada_user_rating_pivot=pd.read_csv("book.csv",
                                        encoding = "ISO-8859-1", index_col='title')
...
@app.route('/recommend')# route to display the home page
def recommend():
    return render_template('recommender.html')#rendering the home page
